...
*/
class Pinhole_Intrinsic_Brown_T2_Rolling : public Pinhole_Intrinsic
{
  using class_type = Pinhole_Intrinsic_Brown_T2_Rolling;
...
#endif // #ifndef OPENMVG_CAMERAS_CAMERA_PINHOLE_BROWN_ROLLING_HPP
