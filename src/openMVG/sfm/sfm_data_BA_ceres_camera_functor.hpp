  ...
  )
  {
    if (rolling_shutter)
    {
      ...
      if (weight == 0.0)
      {
        return
          (new ceres::AutoDiffCostFunction
            <ResidualErrorFunctor_Pinhole_Intrinsic_Brown_T2_Rolling, 2, 8, 9, 3>(
      ...
      else
      {
        return
          (new ceres::AutoDiffCostFunction
            <WeightedCostFunction<ResidualErrorFunctor_Pinhole_Intrinsic_Brown_T2_Rolling>, 2, 8, 9, 3>
            (new WeightedCostFunction<ResidualErrorFunctor_Pinhole_Intrinsic_Brown_T2_Rolling>
              (new ResidualErrorFunctor_Pinhole_Intrinsic_Brown_T2_Rolling(observation.data()), weight)));
      }
    }
    else
    {
